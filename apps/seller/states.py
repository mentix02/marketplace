...
type DjangoChoices = tuple[tuple[str, str], ...]

STATES_CHOICES: DjangoChoices = tuple((slugify(state), state) for state in STATES_CITIES.keys())
CITIES_CHOICES: DjangoChoices = tuple((slugify(city), city) for cities in STATES_CITIES.values() for city in cities)
